  ...
  fastify.post(
    "",
    {
      schema: {
        ...
        description:
          "Create an account as the authority root for account-scoped product access. The authenticated caller becomes account owner, and account activation requirements decide whether the account starts active or pending.",
