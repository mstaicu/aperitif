...
COMMENT ON TABLE accounts IS 'Authority root used for account lifecycle, commercial ownership, and account-scoped product access.';
...
COMMENT ON COLUMN account_memberships.user_id IS 'Identity user id from the identity domain.';
