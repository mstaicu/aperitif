...
Accounts owns accounts, account memberships, and account activation
requirements. It does not own identity credentials, billing, profiles,
documents, notifications, workflow, or integrations.

- Do not publish accounts authority events directly from request handlers. Write
...
- Do not add a public/manual requirement completion endpoint. Future
  ...
  consumer path.
- Do not read identity tables. Accounts verifies identity-issued tokens
