...
import { Space } from "../spaces/schemas.mjs";
...
export const AccountRole = Type.Union(
  ...
  {
    description:
      "Account role. Account authority is tenant/control-plane authority, not implicit authority inside every space.",
  },
);
...
export const CreateAccountSpaceBody = Type.Object(
  {
    name: Type.String({
      description:
        "Human-readable name for the new optional sub-authority context.",
      maxLength: 160,
      minLength: 1,
    }),
  },
  {
    additionalProperties: false,
    description:
      "Payload for creating a space under an account. Account-only products do not need to call this.",
  },
);
...
export const AccountRequirement = Type.Object(
  ...
  },
  {
    additionalProperties: false,
    description:
      "Requirement row tracked against account activation. Other domains fulfill these requirement types; spaces tracks their status.",
  },
);
...
export const AccountSpacesResponse = Type.Object(
  {
    account: Account,
    count: Count,
    spaces: Type.Array(Space),
  },
  {
    additionalProperties: false,
    description:
      "Optional spaces owned by an account. This is account-level metadata, not proof of space business authority.",
  },
);
